...
def create_preprocessor():
    ...
    numerical_features = ['sqft', 'bedrooms', 'bathrooms', 'house_age', 'price_per_sqft',
                          'bed_bath_ratio']
...
def run_feature_engineering(input_file, output_file, preprocessor_file):
    ...
    y = df_featured[
        'price'] if 'price' in df_featured.columns else None  # Target column (if available)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--preprocessor', required=True,
                        help='Path for saving the preprocessor')
